...
public class BAStoRDFconverter {
	...
	private static Logger log = LoggerFactory.getLogger(BAStoRDFconverter.class);
	
	private Model rdfModel;
	
	public BAStoRDFconverter() {
		log.info("Knowledge Graph Generator");
	}

	public Model csvConvert(Reader targetReader) throws IOException, ParseException {
