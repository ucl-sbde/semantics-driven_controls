...
In the [examples directory](semantics-driven_controls/semantics-driven_controls/examples
/TUC/), you will find sample files in IFC and CSV formats. These sample files serve as illustrative inputs for the mapping algorithms. The directory also contains the models generated by the algorithms. 
