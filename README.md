...
The [examples directory](https://github.com/ucl-sbde/semantics-driven_controls/tree/main/examples) includes sample files in IFC and CSV formats. These sample files serve as illustrative inputs for the mapping algorithms. The directory also contains the models generated by the algorithms for these two sample files. 

2. Brick and SAREF driven SPARQL queries

The [examples directory](https://github.com/ucl-sbde/semantics-driven_controls/tree/main/examples) also includes SPARQL queries to support the configuration of control applications using both Brick and SAREF concepts.